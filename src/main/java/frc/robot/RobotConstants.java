...
public final class RobotConstants {
    ...
    public static final class ReefAimConstants {
        ...
        public static final TunableNumber ROBOT_TO_PIPE_METERS = new TunableNumber("AIM/ROBOT_TO_PIPE_METERS", 0.55);
    ...
    public static class EndEffectorArmConstants {
        ...
        public static final TunableNumber ALGAE_PRESHOOT_ANGLE = new TunableNumber("END_EFFECTOR_ARM_PIVOT/algaePreShootAngle", 245.0);
