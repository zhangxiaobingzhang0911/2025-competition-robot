...
public class PutAlgaeCommand extends ParallelCommandGroup {
    public PutAlgaeCommand(CommandXboxController driverController, EndEffectorArmSubsystem endeffectorArmSubsystem,
