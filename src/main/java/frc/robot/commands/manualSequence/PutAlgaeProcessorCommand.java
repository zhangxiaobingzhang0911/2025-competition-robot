...
public class PutAlgaeProcessorCommand extends ParallelCommandGroup {
    public PutAlgaeProcessorCommand(CommandXboxController driverController, EndEffectorArmSubsystem endeffectorArmSubsystem,
        ...
        addCommands(
                Commands.parallel(
                        Commands.runOnce(() -> endeffectorArmSubsystem.setWantedState(EndEffectorArmSubsystem.WantedState.ALGAE_PROCESSOR_PRESHOOT)),
                        Commands.runOnce(() -> elevatorSubsystem.setElevatorPosition(RobotConstants.ElevatorConstants.ALGAE_PROCESSOR_EXTENSION_METER.get())),
                        Commands.sequence(
                                Commands.waitUntil(() -> driverController.rightTrigger().getAsBoolean()),
                                Commands.runOnce(() -> endeffectorArmSubsystem.setWantedState(EndEffectorArmSubsystem.WantedState.ALGAE_PROCESSOR_SHOOT)),
